...
import { ArrowRightRounded, CheckRounded } from '@mui/icons-material';
...
export function ContextMenuSubTrigger({
  ...
  return (
    ...
    >
      ...
      <ArrowRightRounded className="text-outline-variant dark:text-outline size-5" />
    </ContextMenuPrimitive.SubTrigger>
  );
}
  ...
  return (
    ...
    >
      ...
      <ContextMenuPrimitive.ItemIndicator>
        <CheckRounded className="text-primary size-5" />
      </ContextMenuPrimitive.ItemIndicator>
    </ContextMenuPrimitive.CheckboxItem>
  );
};

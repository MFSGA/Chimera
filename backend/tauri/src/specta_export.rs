...
pub(crate) fn build_specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    ...
    let builder = build_builder![
        ...
        features::agent::commands::agent_execute_read_only_intent,
        features::agent::commands::agent_authorize_autonomy,
        features::agent::commands::agent_get_autonomy_policy,
        features::agent::commands::agent_revoke_autonomy,
...
mod tests {
    ...
    fn agent_bindings_are_absent_without_feature() {
        ...
        for command in [
            ...
            "agentResolveIntent:",
            "agentExecuteReadOnlyIntent:",
            "agentAuthorizeAutonomy:",

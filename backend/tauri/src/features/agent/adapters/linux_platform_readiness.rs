...
pub(crate) struct LinuxPlatformReadiness {
    core: UnixPlatformReadinessCore,
}

impl LinuxPlatformReadiness {
...
impl PlatformReadinessPort for LinuxPlatformReadiness {
...
mod tests {
    ...
    use super::{LinuxPlatformReadiness, query_process_privilege};
    ...
    async fn wrapper_delegates_to_the_shared_core() {
        ...
        let readiness = LinuxPlatformReadiness::with_collector(Arc::new(move || {
